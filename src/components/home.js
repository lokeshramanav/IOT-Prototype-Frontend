...
const Home = ()=> {
    ...
    const getUserName = ()=>{
        return (
            <div className="login-clean" style={{width:"500px" ,height: "1000px",backgroundColor: "rgb(135,177,213)"}}>
            <form >
            <h2 className="sr-only">Login Form</h2>
            <p style={{fontFamily: "Allerta, sans-serif",backgroundColor: "#ffffff",fontSize: "25px"}}>Hi!!! There how do we call you</p>
            <div className="illustration"></div>
            <div className="form-group"><input value={userName} onChange={(event)=> setUserName(event.target.value)}className="form-control" type="text" style={{backgroundColor: "rgb(236,249,244)",fontFamily: "Allerta, sans-serif"}}/></div>
